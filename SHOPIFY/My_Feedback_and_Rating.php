...
$statement = oci_parse($connection, 'SELECT f.customerid,f.feedbackid,p.pname,f.f_description,f.feedbacktime FROM Step2Shopify_Feedback f,Step2Shopify_Product p where f.productid=p.productid and f.customerid='.$userid.'order by f.feedbacktime desc');
